...
<body>
    ...
    <div id="viewOrder">
        ...
        <div>
            ...
            <?php foreach ($order as $oderItem) :   ?>
                <p><strong>Confirmation date:</strong> <?php echo $oderItem['confirmation_date'] ?? 'null'; ?></p>
                <p><strong>Total Price:</strong><?php echo '$' . ($oderItem['total_price'] ?? 'null'); ?></p>
                <p><strong>Status:</strong> <?php echo $oderItem['status'] ?? 'null'; ?></p>
                <form action="server.php" method="post">
                    <input type="hidden" name="oredrID" value="<?php echo $oderItem['id']; ?>">
                    <button type="submit" name="deleteorder">Delete Order</button>
                </form>
            <?php endforeach ?>
        </div>
    </div>
